  ...
  <input type="hidden" name="id_empresa" value="<?php echo $_SESSION["id_empresa"]; ?>" />
    <div class="campo_form">
	 ...
	 <div class="campo_form">
        ...
        <input type="text" name="nombrecontacto" class="nombrecontacto">
    </div>
	<div class="campo_form">
        <label class="label_width">Nombre del contacto 2</label>
        <input type="text" name="nombrecontacto2" class="nombrecontacto2">
    </div>
	 <div class="campo_form">
        <label class="label_width">Nombre de la empresa</label>
        <input type="text" name="nombreempresa" class="nombreempresa">
    </div>
    ...
    <div class="campo_form">
	 ...
	 <div class="campo_form">
        <label class="label_width">Pagina Web</label>
...
<form id="f_proveedores_fiscal" class="formularios">
  ...
  <input type="hidden" name="id_empresa" value="<?php echo $_SESSION["id_empresa"]; ?>" />
    ...
    <div class="campo_form">
		...
		<!-- Originalmente era direccion fiscal , se hixo cambio -->
