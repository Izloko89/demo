  ...
  <div id="hacer">
        ...
        <div class="campo_form celda">
            ...
            <?php //si viene con una clave dedde otra pagina
				...
				$(document).ready(function(e){
					buscarClaveGet(<?php echo $_GET["cve"]; ?>);
				});
				</script>
      ...
      <div class="tabla">
        <div class="celda" style=" width:600px;">
          ...
          <div class="campo_form">
            ...
            <input name="nombrecontacto" class="nombrecontacto text_largo" type="text" />
          </div>
		   <div class="campo_form">
          	<label>Cargo del contacto</label>
            <input name="cargocontacto" class="cargocontacto text_largo" id="cargocontacto" type="text" />
          </div>
             <div class="campo_form">
            <label style="width:120px;">Direccion del Evento</label>
			<input type="text" id="dirEvento" name="dirEvento" class="dirEvento text_largo"/>
          </div>
          <div class="campo_form">
            <label style="width:120px;">Telefono contacto</label>
			<input type="text" id="telefonoContacto" name="telefonoContacto" class="telefonoContacto text_largo"/>
          </div>
		   <div class="campo_form">
            <label style="width:120px;">Responsable en dar seguimiento</label>
			<input type="text" id="responsableseg" name="responsableseg" class="responsableseg text_largo"/>
          </div>
		  
		   <div class="campo_form">
            <label style="width:120px;">No. de invitados</label>
			<input type="text" id="noinvitados" name="noinvitados" class="noinvitados text_corto"/>
          </div>
		</div>
        <div class="celda" style="">
          ...
          <div class="campo_form">
		   ...
		   <div class="campo_form">
            <label class="align_right" style="width:120px;">Fecha final</label>
        	<abbr title=""><input placeholder="Click para elegir" class="fecha alejar_izq requerido fechafinal" type="text" name="fechafinal" id="fechafinal" readonly/></abbr><!--
            --><img class="borrar_fecha" data-class="fechafinal" src="img/cruz.png" width="15" />
          </div>
		</div>
      </div>
        <div align="right">
		<input type="hidden" id="tabla" value="eventos"/>
    ...
    <h3 class='titulo_form'>Observaciones</h3>
	  ...
	  <table class="">
        ...
        <input type="hidden" name="id_evento" class="id_evento" value="" />
        <textarea name="obs" id="observaciones" placeholder="Anota aquí las observaciones de la nota"></textarea>
		
		<br />
		<div align="right">
		  <input type="submit" onclick="this.form.action='scripts/nota_venta_pdf.php'" value="Hoja de bulto"/>
        <input type="submit" onclick="this.form.action='scripts/nota_venta_pdf.php'" value="Ficha de control"/>
		  <input type="submit" onclick="this.form.action='scripts/pdf_contrato.php'" value="Contrato"  />
		  <input type="submit" onclick="this.form.action='scripts/pdf_contrato_m.php'" value="Contrato m"  />
		    <input type="submit" onclick="" value="Facturar"/></div>
      </form>
    </div>
  </div>
